...
public class Constants {
    ...
    public static final String RTC_TOKEN = "https://hio283oj8h.execute-api.us-east-1.amazonaws.com/v1/rtctoken/";
    ...
    public static final String PREF_NAME = "io.quicktalk.agilean";
